...
class QuakeClassifierNeural:
    """
    A class to handle earthquake data processing and classification
    using Neural Networks (MLPClassifier).

    This class provides methods to fetch earthquake data from GeoNet,
    process and filter the data, train an MLP classifier,
    and generate map visualization data.
    """

    def __init__(self, filters=None):
        """
        Initialize the QuakeClassifierNeural with optional filters.
        ...
        # Filter out model_type from config for MLPClassifier
        mlp_params = {
            k: v for k, v in NEURAL_MODEL_CONFIG.items() if k != "model_type"
        }  # noqa: E501
    ...
    def train_model(
        ...
        """
        Train the neural network model and generate performance metrics.
        ...
        print("\nMLP Neural Network Model Performance:")
    ...
    def _generate_model_visualization(self, features_train, labels_train):
        ...
        # Save the plot
        plt.tight_layout()
        plt.savefig("neural_model.png", dpi=300, bbox_inches="tight")
        plt.close()

        print("Model visualization saved as 'neural_model.png'")
...
def main():
    ...
    """
    print("🧠 GeoNet Earthquake Neural Model Classifier")
    print("=" * 48)
    print("Fetching earthquake data from GeoNet...")

    qc = QuakeClassifierNeural()
    ...
    if NEURAL_MODEL_MAP_INTENSITY_TYPE == "predicted":
    ...
    print("🧠 View results: neural_model.html")
